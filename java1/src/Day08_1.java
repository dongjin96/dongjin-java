...
public static void main(String[] args) {
	...
	System.out.println("모델 :"+DmbCellPhone.model);//private 변수가 아닐경우 맴버 접근기능
	System.out.println("색상 : "+dembCellPhone.color);// 부모멤버
	System.out.println("채널 :" +dmbCellPhone.channel); //본인필드
